...
df1 <- read.csv2(paste0("../Results/eboplusAccuracyTable_1.csv"))
df2 <- read.csv2(paste0("../Results/eboplusAccuracyTable_2.csv"))
df3 <- read.csv2(paste0("../Results/eboplusAccuracyTable_3.csv"))
df4 <- read.csv2(paste0("../Results/eboplusAccuracyTable_4.csv"))
...
df1$Group <- c(rep("SVM-based",each=3), rep("voom-based",each=3), 
               rep("LDA-based",each=3), #rep("NNet-based",each=2),
